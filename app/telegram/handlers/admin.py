...
""".format(
        ...
        total_bandwidth=readable_size((bandwidth.uplink if bandwidth else 0) + (bandwidth.downlink if bandwidth else 0)),
        up_bandwidth=readable_size(bandwidth.uplink if bandwidth else 0),
        down_bandwidth=readable_size(bandwidth.downlink if bandwidth else 0),
